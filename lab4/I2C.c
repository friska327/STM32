...
/*
void Send_mess_EEPROM(char Start_addr, char num)
{
		while(I2C1->SR2&I2C_SR2_BUSY){;}
		Send_Addr(Addr_Transmite);
		Send_Byte(Start_addr);	

		DMA_TX_GO(BUFF_TX, num);
}

void Recive_mess_EEPROM(char Start_addr, char num)
{
		while(I2C1->SR2&I2C_SR2_BUSY){;}
		Send_Addr(Addr_Transmite);
